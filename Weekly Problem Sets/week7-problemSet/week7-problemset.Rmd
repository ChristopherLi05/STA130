...
Q1b_road_sample <- roaddata %>% sample_n(size=10)
```
...
```{r}
Q1c_i_repetitions <- 1 ## Replace 1 by your answer
Q1c_i_simulated_values <- NULL ## Replace NULL by your answer
```
...
Q1d_90_ci_lower_bound <- NULL
Q1d_90_ci_upper_bound <- NULL
...
```{r}
Q2b_n <- 1 # Replace 1 by your answer
Q2b_repetitions <- 1 # Replace 1 by your answer
Q2b_vector_for_simulated_values <- 1 # Replace 1 by your answer
```
...
Q2c_95_ci_lower_bound <- NULL
Q2c_95_ci_upper_bound <- NULL
```
